...
namespace WindowsFormsApp1
{
    public partial class TrangChu : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'quanLyKhachSan_SQL6DataSet.CT_PHIEUSUDUNGDICHVU' table. You can move, or remove it, as needed.
            //this.cT_PHIEUSUDUNGDICHVUTableAdapter.Fill(this.quanLyKhachSan_SQL6DataSet.CT_PHIEUSUDUNGDICHVU);
        ...
        private void button15_Click_1(object sender, EventArgs e)
        {
            ...
            using (connect = new SqlConnection(str))
            {
                ...
                for (int i = 0; i < dataGridView2.Rows.Count; i++)
                {
                    ...
                    {
                        command = new SqlCommand("insert CT_PHIEUSUDUNGDICHVU values('" + mapd + "','" + dataGridView2.Rows[i].Cells[1].Value.ToString() + "','" + dataGridView2.Rows[i].Cells[2].Value.ToString().Trim() + "')", connect);
                        command.ExecuteNonQuery();
                    }
                }
            }
